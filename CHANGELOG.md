...
### Changed
- **Refactored** CustomCursor internals to Terra pattern for improved code consistency
- **Demo redesigned**: live demo at [cursor.andresclua.com](https://cursor.andresclua.com)
